          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                {t('nav.invitationCodes', 'Invitation Codes')}
              </h2>
              <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                {t('referrals.inviteUpTo3', 'Invite up to 3 friends and get exclusive benefits')}
              </p>
            </div>
            <button
              onClick={onClose}
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-6 mb-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
                  {t('referrals.yourInvitationCode', 'Your Invitation Code')}
                </h3>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{t('referrals.used', 'Used')}</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                  <p className="text-3xl font-bold text-green-600 dark:text-green-400">
                    {invitationData.codesRemaining}
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{t('referrals.available', 'Available')}</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                  <p className="text-3xl font-bold text-purple-600 dark:text-purple-400">
                    {invitationData.maxCodes}
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{t('common.total', 'Total')}</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg p-6 mb-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                  ...
                  {t('referrals.benefitsForInviting', 'Benefits for inviting')}
                </h3>
                <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>{t('referrals.thirdBenefit', '3% permanent commission (vs 5% normal)')}</span>
                  </li>
                </ul>
              </div>
              ...
              {invitationData.invitedUsers && invitationData.invitedUsers.length > 0 && (
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
                    {t('referrals.invitedUsers', 'Invited Users')} ({invitationData.invitedUsers.length})
                  </h3>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400">
                            {t('referrals.registered', 'Registered')} {new Date(invitedUser.createdAt).toLocaleDateString('es-AR')}
                          </p>
                        </div>
                      </div>
                    ))}
              ...
              {invitationData.codesRemaining === 0 && (
                <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                  <p className="text-sm text-yellow-800 dark:text-yellow-200">
                    {t('referrals.allCodesUsed', 'You have used all your invitation codes. Wait for your invitees to complete contracts to receive your benefits!')}
                  </p>
                </div>
              )}
            </>
            ...
            <div className="text-center py-8">
              <p className="text-gray-600 dark:text-gray-400">
                {t('referrals.couldNotLoad', 'Could not load invitation information')}
              </p>
            </div>
          )}
