        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-amber-50 dark:bg-amber-900/10">
            ...
            <ul className="space-y-2 text-sm text-amber-800 dark:text-amber-300">
              ...
              <li className="flex items-start gap-2"><span className="mt-0.5">🕒</span> <span><Trans i18nKey="jobPayment.tip3" components={{ b: <strong /> }} defaults="Podés cancelar hasta el inicio del trabajo. Con <b>más de 24 horas</b> de anticipación se te reembolsa el precio del trabajo; con <b>24 horas o menos</b>, se reembolsa <b>la mitad del precio a vos y la otra mitad al trabajador</b>. Si todavía <b>no hay ningún trabajador seleccionado</b>, se te reembolsa la <b>totalidad del precio</b> (la comisión no se reembolsa)." /></span></li>
