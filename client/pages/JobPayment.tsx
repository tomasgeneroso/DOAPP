        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-amber-50 dark:bg-amber-900/10">
            ...
            <ul className="space-y-2 text-sm text-amber-800 dark:text-amber-300">
              ...
              <li className="flex items-start gap-2"><span className="mt-0.5">🕒</span> <span>Podés cancelar hasta el inicio del trabajo. Con <strong>más de 2 horas</strong> de anticipación se te reembolsa el precio del trabajo; con <strong>2 horas o menos</strong>, se reembolsa <strong>la mitad del precio a vos y la otra mitad al trabajador</strong>. Si todavía <strong>no hay ningún trabajador seleccionado</strong>, se te reembolsa la <strong>totalidad</strong> (precio + comisión).</span></li>
