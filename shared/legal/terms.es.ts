...
export const termsEs: Record<string, string> = {
  ...
  "s7p9": "7.9. <b>Saldo a favor y su transferencia.</b> Los importes que vuelven al Cliente —por una cotización menor al precio publicado, por una cancelación o por un rechazo de la publicación— se acreditan como saldo a favor dentro de la Plataforma. Ese saldo puede utilizarse sin costo alguno en cualquier publicación o contratación posterior. El Cliente también puede solicitar su transferencia a una cuenta bancaria propia; en ese caso <b>se descuentan el costo de procesamiento que cobró la pasarela de pago</b> por el ingreso de ese dinero y, cuando corresponda según el punto 9.1, la parte de la comisión allí indicada. Los importes exactos se informan antes de confirmar la solicitud. Si el Cliente no acepta el descuento, el saldo permanece disponible en la Plataforma por tiempo indeterminado. El costo de procesamiento que se traslada es la tarifa de la pasarela sin su IVA; ese IVA es a cargo de la Plataforma.",
  "s7p10": "7.10. <b>Tarifas y plazos de la pasarela.</b> El costo de procesamiento y el plazo en que la pasarela de pago pone el dinero a disposición dependen del medio que elija quien paga (tarjeta, dinero en cuenta, cuotas) y de las condiciones vigentes del proveedor, que pueden cambiar sin aviso previo a DOAPP. Por eso el importe exacto que recibe el Trabajador y la fecha estimada de transferencia se informan al postularse y al confirmarse el trabajo, con los datos reales de ese pago, y pueden diferir de los valores orientativos publicados. DOAPP no percibe ningún importe por ese costo: se traslada tal cual.",
  ...
  "s9p1": `9.1. <b>Cancelaciones sin Trabajador seleccionado</b> (antes de la aprobación de la publicación, o después de aprobada mientras ningún Trabajador haya sido seleccionado): la totalidad de lo abonado, comisión incluida, se acredita como saldo a favor en la Plataforma, utilizable sin costo en nuevas publicaciones. Si el Cliente solicita transferir ese saldo a una cuenta bancaria, se descuentan el ${REVISION_PARTE_PCT}% de la comisión con su IVA, por la revisión ya realizada (con la comisión vigente, equivale al ${REVISION_COMISION_PCT}% del precio con un mínimo de EUR ${REVISION_PISO_EUR}), y el costo de procesamiento de la pasarela de pago. El rechazo de una publicación por parte de un Administrador se liquida de la misma manera, y el Administrador debe indicar el motivo.`,
  "s9p2": `9.2. <b>Cancelaciones del Cliente con Trabajador seleccionado y al menos ${P.CANCELACION_CLIENTE_HORAS_ANTES} horas de anticipación al inicio</b>: el precio del trabajo se acredita como saldo a favor en la Plataforma; la comisión de publicación no se reembolsa. Si el Cliente transfiere ese saldo a una cuenta bancaria, se descuenta el costo de procesamiento de la pasarela conforme al punto 7.9.`,
  "s9p3": `9.3. <b>Cancelaciones tardías del Cliente con Trabajador seleccionado</b> (con menos de ${P.CANCELACION_CLIENTE_HORAS_ANTES} horas de anticipación, o durante la ejecución): el ${PARTE_TRABAJADOR_PCT}% del precio se le paga al Trabajador por el tiempo que reservó, descontada la parte del costo de procesamiento de la pasarela que corresponde a ese importe; el resto se acredita al Cliente como saldo a favor, y al transferirlo se descuenta la parte de la pasarela que le corresponde. La comisión de publicación se retiene. Si el que cancela es el Trabajador —avisando a través de la función prevista en la Plataforma, antes del inicio o durante la ejecución—, el Trabajador no percibe importe alguno y queda sujeto al punto 9.4, y el Cliente elige: mantener la publicación abierta con los fondos ya abonados para seleccionar a otro Trabajador, republicarla por un precio menor (la diferencia se acredita como saldo a favor), o que el precio del trabajo se acredite íntegramente como saldo a favor. En los tres casos la comisión de publicación se retiene, y al transferir el saldo se descuenta el costo de procesamiento conforme al punto 7.9.`,
