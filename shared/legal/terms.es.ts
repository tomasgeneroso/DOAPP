...
export const termsEs: Record<string, string> = {
  ...
  "s7p5": "7.5. La comisión de DOAPP no es reembolsable una vez que la publicación fue aprobada, incluso en casos de cancelación o disputa. La única excepción es la cancelación previa a la aprobación (punto 9.1), en la que se devuelve íntegramente.",
  ...
  "s9p1": "9.1. Cancelaciones previas a la aprobación de la publicación por parte de un Administrador: devolución total de lo abonado, comisión incluida, <b>menos el costo de procesamiento que ya cobró la pasarela de pago</b>, que no es reembolsable. El importe se acredita como saldo a favor en la Plataforma.",
