...
export const termsEs: Record<string, string> = {
  ...
  "s7p9": "7.9. <b>Saldo a favor, devolución y transferencia.</b> Cuando corresponde devolverle importes al Cliente —por una cotización menor al precio publicado, por una cancelación o por un rechazo de la publicación— <b>el Cliente elige entre dos vías, informadas antes de confirmar</b>: (a) <b>saldo a favor</b> dentro de la Plataforma, que puede utilizarse sin costo alguno en cualquier publicación o contratación posterior, y cuya parte abonada con saldo no pasa por la pasarela ni paga costo de procesamiento; o (b) <b>devolución al medio de pago utilizado</b>, cuyo plazo de acreditación depende del emisor. El saldo a favor también puede transferirse luego a una cuenta bancaria propia del Cliente. Tanto la devolución al medio de pago como la transferencia bancaria implican que el dinero sale de la Plataforma, y en ambos casos se descuenta, cuando corresponda según el punto 9.1, la parte de la comisión allí indicada; fuera de ese descuento <b>ninguna de las dos tiene costo</b>. Si el Cliente no acepta ese descuento, el saldo permanece disponible en la Plataforma por tiempo indeterminado.",
  ...
  "s9p1": `9.1. <b>Cancelaciones sin Trabajador seleccionado</b> (antes de la aprobación de la publicación, o después de aprobada mientras ningún Trabajador haya sido seleccionado): la totalidad de lo abonado, comisión incluida y con excepción del costo de procesamiento del pago (punto 7.10), vuelve al Cliente por la vía que él elija conforme al punto 7.9. Si elige el saldo a favor, se acredita completo y puede usarlo sin costo en nuevas publicaciones. Si elige la devolución al medio de pago, o si más adelante transfiere ese saldo a una cuenta bancaria, se descuenta el ${REVISION_PARTE_PCT}% de la comisión con su IVA, por la revisión ya realizada (con la comisión vigente, equivale al ${REVISION_COMISION_PCT}% del precio con un mínimo de EUR ${REVISION_PISO_EUR}). El rechazo de una publicación por parte de un Administrador se liquida de la misma manera, y el Administrador debe indicar el motivo.`,
