...
export const termsEs: Record<string, string> = {
  ...
  "s7p8": "7.8. <b>Monto mínimo de contratación.</b> El monto mínimo de un trabajo es de $18.000 ARS. Este mínimo no es una tarifa: surge de que cada contrato tiene un costo fijo para la Plataforma —procesamiento del pago, custodia de fondos, verificación de identidad y atención de disputas— que no disminuye cuando el importe del trabajo es menor. Por debajo de ese monto, la comisión no alcanza a cubrir ese costo y el contrato no puede sostenerse. El mínimo se verifica al aceptar una cotización, que es el momento en que existe un precio definitivo; una publicación \"a cotizar\" puede crearse sin precio.",
