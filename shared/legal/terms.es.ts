...
export const termsEs: Record<string, string> = {
  ...
  "s9p2": `9.2. Cancelaciones del Cliente con al menos ${P.CANCELACION_CLIENTE_HORAS_ANTES} horas de anticipación al inicio: devolución del precio del trabajo como saldo a favor en la Plataforma. La comisión de publicación no se reembolsa una vez que la publicación fue aprobada.`,
  "s9p3": `9.3. <b>Cancelaciones tardías del Cliente</b> (con menos de ${P.CANCELACION_CLIENTE_HORAS_ANTES} horas de anticipación, o durante la ejecución): si había un Trabajador seleccionado, el ${PARTE_TRABAJADOR_PCT}% del precio se le paga al Trabajador por el tiempo que reservó y el resto vuelve al Cliente como saldo a favor; si no había Trabajador seleccionado, el precio vuelve íntegro al Cliente. En ambos casos la comisión de publicación se retiene.`,
  "s9p4": `9.4. <b>Cancelación por parte del Trabajador de un contrato aceptado.</b> Cancelar un trabajo ya aceptado perjudica al Cliente y a la Plataforma. Por ello, las cancelaciones del Trabajador dentro de un período de ${P.CANCELACION_VENTANA_DIAS} días tienen consecuencias graduales: la primera genera un aviso; la segunda hace visible en el perfil del Trabajador, durante ${P.CANCELACION_MARCA_VISIBLE_DIAS} días, una marca que indica que canceló trabajos aceptados; la tercera o siguientes suspenden la posibilidad de postularse a nuevos trabajos durante ${P.CANCELACION_SUSPENSION_DIAS} días. Los contratos en curso no se ven afectados por la suspensión. Avisar oportunamente que no se podrá realizar el trabajo, a través de la función prevista en la Plataforma, se considera igualmente una cancelación a estos efectos, pero permite al Cliente decidir cómo disponer de su dinero sin demoras.`,
  ...
  "s10p7": `10.7. <b>Plazo para reclamar:</b> La disputa puede iniciarse mientras el contrato está en curso y hasta ${P.DIAS_PARA_DISPUTAR} días corridos después de su finalización. Pasado ese plazo, el contrato se considera aceptado sin observaciones. La apertura de una disputa dentro de ese plazo no retiene fondos ya liberados, pero habilita la mediación de DOAPP y queda registrada.`,
