...
export const termsEs: Record<string, string> = {
  ...
  "s7p4": `7.4. <b>Comisión mínima.</b> La comisión tiene un piso equivalente a EUR ${MINIMUM_COMMISSION_EUR}, convertido a pesos al tipo de cambio del día e informado antes de pagar. El piso cubre el costo fijo que tiene cada contrato para la Plataforma. El monto mínimo de contratación (punto 7.8) está fijado de modo que ese piso no distorsione el precio del trabajo.`,
  "s7p5": `7.5. La comisión de DOAPP no es reembolsable una vez que la publicación fue aprobada, incluso en casos de cancelación o disputa. La única excepción es la cancelación previa a la aprobación (punto 9.1), en la que se devuelve el ${100 - REVISION_PARTE_PCT}% de la comisión.`,
  ...
  "s9p1": `9.1. Cancelaciones previas a la aprobación de la publicación por parte de un Administrador: se devuelve el precio del trabajo y el ${100 - REVISION_PARTE_PCT}% de la comisión con su IVA. DOAPP retiene el ${REVISION_PARTE_PCT}% restante de la comisión por la revisión ya realizada (con la comisión vigente, equivale al ${REVISION_COMISION_PCT}% del precio con un mínimo de EUR ${REVISION_PISO_EUR}), <b>y no se reembolsa el costo de procesamiento que ya cobró la pasarela de pago</b>. El importe se acredita como saldo a favor en la Plataforma.`,
  "s9p2": `9.2. Cancelaciones del Cliente con al menos ${P.CANCELACION_CLIENTE_HORAS_ANTES} horas de anticipación al inicio: devolución del precio del trabajo como saldo a favor en la Plataforma, <b>menos el costo de procesamiento de la pasarela</b>, que ya fue cobrado y no vuelve. La comisión de publicación no se reembolsa una vez que la publicación fue aprobada.`,
  "s9p3": `9.3. <b>Cancelaciones tardías del Cliente</b> (con menos de ${P.CANCELACION_CLIENTE_HORAS_ANTES} horas de anticipación, o durante la ejecución): del precio, descontado el costo de procesamiento de la pasarela, si había un Trabajador seleccionado el ${PARTE_TRABAJADOR_PCT}% se le paga al Trabajador por el tiempo que reservó y el resto vuelve al Cliente como saldo a favor; si no había Trabajador seleccionado, vuelve todo al Cliente. En ambos casos la comisión de publicación se retiene. El saldo a favor puede usarse en la Plataforma sin costo o transferirse conforme al punto 7.9.`,
