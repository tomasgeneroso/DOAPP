...
export const termsEn: Record<string, string> = {
  ...
  "s9p1": "9.1. Cancellations prior to approval of the publication by an Administrator: full refund of the amount paid, commission included, <b>minus the processing cost already charged by the payment gateway</b>, which is non-refundable. The amount is credited as Platform credit.",
