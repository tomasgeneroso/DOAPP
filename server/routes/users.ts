  ...
  try {
    ...
    res.json({
      ...
      user: {
        ...
        doerReviewsCount: user.doerReviewsCount,
        clientRating: user.clientRating,
        clientReviewsCount: user.clientReviewsCount,
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        contractsCompleted: (user as any).completedContracts,
        role: user.role,
        isVerified: user.isVerified,
...
router.get("/:id/completed-jobs", async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const formattedContracts = contracts.map(contract => {
      ...
      return {
        id: contract.id,
        completedAt: (contract as any).completedAt || contract.updatedAt,
